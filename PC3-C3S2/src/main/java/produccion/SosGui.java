...
public class SosGui extends JFrame {
  ...
  //Jhonatan
  private JRadioButton btnGrabar;
  //Jhonatan
  ...
  /**
   * Panel que contiene el turno actual, muestra el resultado y contiene al botón NuevoJuego(Reset)
   */
...
//          //jhonatan
      ...
      btnGrabar = new JRadioButton("Grabar", false);
